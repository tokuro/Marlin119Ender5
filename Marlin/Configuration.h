...
#define STRING_CONFIG_H_AUTHOR "TY, v2 (Ender-5)" // Who made the changes.
...
#define BLTOUCH
#if ENABLED(BLTOUCH)
  #define BLTOUCH_DELAY 120   // (ms) Enable and increase if needed
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (20*60) //(50*60)
